...
describe("Interaction", function () {
    ...
    describe("#withRequest", function () {
        ...
        it("throws error when an invalid method is provided", function () {
            expect(interaction.withRequest.bind(interaction, { method: "FOO" })).to.throw(Error, "You must provide a valid HTTP method: GET, POST, PUT, PATCH, DELETE, HEAD, OPTIONS, COPY, LOCK, MKCOL, MOVE, PROPFIND, PROPPATCH, UNLOCK.");
        });
        it("throws error when method is not provided", function () {
